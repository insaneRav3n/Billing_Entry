<?php
        ...
        */
        class Dbconnect extends PDO
        {
            ...
            private $dbuser     = 'phpmyadmin'; // Set your database username
            private $dbpassword = 'Bill@5511'; //Set your database password
            private $dbname     = 'isp'; // This can be changed too into yours
